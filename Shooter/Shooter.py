    ...
    def attack(self):
        ...
        for rep in range(100):
            ...
            if "up" in directionList:
                pygame.draw.rect(screen, black,(xUP+25, yUP-65, 10, 50))
            if "down" in directionList:
                pygame.draw.rect(screen, black,(xDOWN+25, yDOWN+50, 10, 50))
            if "right" in directionList:
            ...
            for rect in removeList:
                if rect in killList:
                    killList.remove(rect)

            if "up" in directionList:  
                yUP -= 10
                bullet = pygame.draw.rect(screen, red,(xUP+25, yUP-65, 10, 50))
                killList.append(bullet)
                removeList.append(bullet)
            if "down" in directionList:
                yDOWN += 10
                bullet = pygame.draw.rect(screen, red,(xDOWN+25, yDOWN+55, 10, 50))
                killList.append(bullet)
                removeList.append(bullet)
            if "right" in directionList:                
                xRIGHT += 10
                bullet = pygame.draw.rect(screen, red,(xRIGHT+55, yRIGHT+25, 50, 10))
                killList.append(bullet)
                removeList.append(bullet)
            if "left" in directionList:                
                xLEFT -= 10
                bullet = pygame.draw.rect(screen, red,(xLEFT-55, yLEFT+25, 50, 10))
                killList.append(bullet)
                removeList.append(bullet)
